<?php
  ...
  //Navivation is bordered to avoid an overload of to many data records
        ...
        <div class="col-lg-6 pull-left"style="padding-left: 0;">
          <span class="pull-left">
            <label class="col-lg-12 control-label" for="keyword" style="padding-right: 0;">
              <input type="text" value="<?php echo $_GET["keyword"]; ?>" placeholder="search by text" id="" class="form-control" name="keyword" style="height: 41px;">
            </label>
          </span>
